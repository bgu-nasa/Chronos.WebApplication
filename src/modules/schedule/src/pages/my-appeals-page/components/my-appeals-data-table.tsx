...
interface MyAppealsDataTableProps {
    appeals: AppealResponse[];
...
export function MyAppealsDataTable({
    appeals,
    assignments,
    slots,
    activities,
    ...
    const rows: MyAppealRow[] = useMemo(() => {
    ...
    const handleSelectionChange = (e: DataTableSelectionSingleChangeEvent<MyAppealRow[]>) => {
        const row = e.value as MyAppealRow | null;
